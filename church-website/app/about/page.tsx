...
const managingCommittee = [
  {
    ...
    image: "/images/achan.jpg?height=200&width=200",
  },
  {
    name: "Binoy MK",
    position: "Vice President",
    image: "/images/binoy.jpg?height=200&width=200",
  },
    {
    name: "Jobi George",
    position: "Secretary",
    image: "/images/jobigeorge.jpg?height=200&width=200",
  },
      {
    name: "Manoj Mathew",
    position: "Trustee",
    image: "/images/manoj.jpg?height=200&width=200",
  },
        {
    name: "Jinesh Mathew",
    position: "Joint Secretary",
    image: "/images/jineshmathew.jpg?height=200&width=200",
  },
        {
    name: "Sibiraj C Mathew",
    position: "Joint Trustee",
    image: "/images/sibiraj.jpg?height=200&width=200",
  },
          {
    name: "Jomon P Geroge",
    position: "Comitte Member",
    image: "/images/jomon geroge.jpg?height=200&width=200",
  },
  {
    name: "Basil Varghese",
    position: "Comitte Member",
    image: "/images/basil.jpg?height=200&width=200",
  },
    {
    name: "Lalu Paul",
    position: "Comitte Member  & Headmaster of Sunday School",
    image: "/images/lalu.jpg?height=200&width=200",
  },
]
      ...
      <section className="bg-gray-50 py-12 md:py-24">
        <div className="container">
          ...
          <StaggeredChildren
            ...
            animation="fadeInUp"
          >
            {VanithaSamajam.map((member, index) => (
              <div
                key={index}
                className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 max-w-xs mx-auto"
              >
